...
export function LoginForm({ className, ...props }) {
  ...
  return (
    <div className={cn("flex flex-col gap-6 z-1", className)} {...props}>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">
                  {t("description.part1", "Enter your email and password to continue.")}
                </p>
              </div>

              <div className="grid gap-3">
                <Label htmlFor="email">{t("form.email.label", "Email")}</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="grid gap-3">
                <div className="flex items-center">
                  <Label htmlFor="password">{t("form.password.label", "Password")}</Label>
                  <a
                    href="#"
                ...
                <Input
                  id="password"
                  type="password"
                  placeholder={t("form.password.placeholder", "Your password")}
                  required
                />
              </div>
              ...
              <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                <span className="relative z-10 bg-card px-2 text-muted-foreground">
                  {t("oauth.title", "Continue with")}
                </span>
              </div>

              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="w-full" aria-label={t("oauth.apple", "Apple")}>
                  {/* Apple icon */}
                  ...
                  <span className="sr-only">{t("oauth.apple", "Apple")}</span>
                </Button>

                <Button variant="outline" type="button" className="w-full" aria-label={t("oauth.google", "Google")}>
                  {/* Google icon */}
                  ...
                  <span className="sr-only">{t("oauth.google", "Google")}</span>
                </Button>

                <Button variant="outline" type="button" className="w-full" aria-label={t("oauth.meta", "Meta")}>
                  {/* Meta icon */}
                  ...
                  <span className="sr-only">{t("oauth.meta", "Meta")}</span>
                </Button>
              </div>
      ...
      <div className="text-center text-balance text-xs text-muted-foreground *:[a]:underline *:[a]:underline-offset-4 *:[a]:hover:text-primary">
        <Trans
          i18nKey="legal.byContinuing"
          defaults="By clicking continue, you agree to our <1>Terms of Service</1> and <3>Privacy Policy</3>."
          components={{
            1: <a href="#" />,
            3: <a href="#" />,
          }}
